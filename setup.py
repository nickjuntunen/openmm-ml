...
setup(
    ...
    entry_points={
        'openmmml.potentials': [
            ...
            'orb-v3-conservative-20-omat = openmmml.models.orbpotential:OrbPotentialImplFactory',
            'orb-v3-conservative-20-omol = openmmml.models.orbpotential:OrbPotentialImplFactory',
            'orb-v3-direct-20-omat = openmmml.models.orbpotential:OrbPotentialImplFactory',
            'orb-v3-direct-inf-omat = openmmml.models.orbpotential:OrbPotentialImplFactory',
